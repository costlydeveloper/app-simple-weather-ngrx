...
export class RequestCitiesWeatherAction implements Action {
	readonly type: CityWeatherActionType = CityWeatherActionType.REQUEST_CITIES_WEATHER;
...
export class RespondCitiesWeatherAction implements Action {
	readonly type: CityWeatherActionType = CityWeatherActionType.RESPOND_CITIES_WEATHER;

	constructor(public payload: { citiesWeatherResponse: ICityWeatherAPIResponse }) {
	}
}
