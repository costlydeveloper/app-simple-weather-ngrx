...
export class AddFavoriteResponseAction implements Action {
	readonly type: FavoritesActionTypes = FavoritesActionTypes.ADD_FAVORITE_RESPONSE;
...
export class RemoveFavoriteResponseAction implements Action {
	readonly type: FavoritesActionTypes = FavoritesActionTypes.REMOVE_FAVORITE_RESPONSE;
