				...
				<ng-template ngFor let-cityWeather [ngForOf]="citiesWeather$ | async">
					...
					<ng-container *ngIf="!(loader$ | async)">
						...
						<div class="col-md-3 mb-4">
							<app-favorite-item
									[cityWeatherItem]="cityWeather"></app-favorite-item>
...
export class FavoritesComponent implements OnInit, OnDestroy {
	...
	ngOnInit(): void {
		...
		this.subscriptions.push(this.favorites$.subscribe(favorites => {
			...
			if (string) {
				...
				this.toastNotification.forceSingleToast('Notice!', 'There are no favorites!', DialogLayoutDisplay.INFO);
			}
			}));
	}
